...
public extension UIImageView {
    ...
    public var hnk_format : Format<UIImage> {
      ...
      assert(viewSize.width > 0 && viewSize.height > 0, "[\(_reflect(self).summary) \(__FUNCTION__)]: UImageView size is zero. Set its frame, call sizeToFit or force layout first.")
